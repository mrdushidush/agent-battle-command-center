...
/**
 * Ollama Stress Test - Graduated Complexity (1-8)
 *
 * Tests Ollama's limits by running 20 tasks with increasing complexity.
 * Goal: Find the complexity threshold where Ollama starts failing >60% of tasks.
 *
...
async function main() {
  ...
  console.log('🔥 OLLAMA STRESS TEST - GRADUATED COMPLEXITY (1-8)');
  console.log('═'.repeat(70));
  console.log('Goal: Find complexity threshold where Ollama fails >60%');
